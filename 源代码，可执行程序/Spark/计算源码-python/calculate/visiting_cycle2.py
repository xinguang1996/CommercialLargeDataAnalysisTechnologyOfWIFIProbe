...
def main():
    ...
    es = elasticsearch.Elasticsearch([{'hosts': '192.168.1.52', 'port': '9200'}, {'hosts': '192.168.1.68', 'port': '9200'}], sniff_on_start=True, sniff_on_connection_fail=True, sniffer_timeout=60, request_timeout=1000)
    ...
    count = es.count(index = 'sou', doc_type = 'tz_1', body = query1)

    es.search(index = 'sou', doc_type = 'tz_1', body = query2, size = 1000, _source = True, timeout = 1000, form_ = 0)
