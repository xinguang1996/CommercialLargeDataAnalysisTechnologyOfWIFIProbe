...
es = elasticsearch.Elasticsearch([{'host':'192.168.1.10','port':'9200'},{'host':'192.168.1.12','port':'9200'}],sniff_on_start=True,sniff_on_connection_fail=True,sniffer_timeout=60,request_timeout=1000)
data = json.loads(form)
start_time = datetime.datetime(2017,7,20,12,00,00)	#格式化开始时间
